# Generated by Django 4.0 on 2023-07-25 12:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_product', models.BooleanField(default=False, verbose_name="Ovqat maxsulotimi yoki yo'q")),
                ('cost', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='Chiqim umumiy summasi')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('output', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='outputs.output')),
            ],
        ),
    ]
